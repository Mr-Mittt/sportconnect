...
| 7 | A7 | Enforce `isActive` on sport-tagged create paths in group/location/session domains | `TODO` |
| 8 | A8 | Drop DB-level FK on `user_sport_profiles.user_id` (cross-domain, violates domain-scoped-tables rule) | `TODO` |
