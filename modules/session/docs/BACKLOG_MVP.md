...
| 5 | [SESSION-31](MVP/SESSION-31_HISTORY_DATE_COUNTS_TIMEZONE_BUG.md) | `findHistoryDateCounts` misbuckets early-morning sessions onto the wrong calendar date — real, already-shipped timezone bug found while implementing SESSION-25 | `TODO` |
